...
from map_nav_src.cvdn.parser import parse_args
...
def build_dataset(args, rank=0, is_test=False):
    ...
    train_env = dataset_class(
        ...
        sel_data_idxs=None, name='train', use_player_path=args.use_player_path, args=args
    )
    if args.aug is not None:
        ...
        aug_env = dataset_class(
            ...
            seed=args.seed + rank, sel_data_idxs=None, name='aug', use_player_path=args.use_player_path, args=args
        )
