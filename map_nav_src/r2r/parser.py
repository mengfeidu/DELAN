...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='r2r', choices=['r2r', 'r4r', 'cvdn', 'landr2r','landr4r','landcvdn','rxr','landrxr'])
    ...
    parser.add_argument("--features", type=str, default='clip-16')
