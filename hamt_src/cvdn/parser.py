...
def parse_args():
    ...
    parser.add_argument('--root_dir', type=str, default='/remote-home/mfdu/VLN/Mycode/TD-STP/datasets')
    parser.add_argument(
        '--dataset', type=str, default='cvdn', 
        choices=['cvdn','landcvdn']
    )
    ...
    parser.add_argument("--last_emb_cl", type=bool, default=False, help='use last layer embeddings to compute cl loss')
    ...
    parser.add_argument("--val_seen_la_path", type=str, default='../LAR2R/lar2r_val_seen.json')
    parser.add_argument("--val_unseen_la_path", type=str, default='../LAR2R/lar2r_val_unseen.json')
    parser.add_argument("--train_la_path", type=str, default='../LAR2R/lar2r_train.json')
    parser.add_argument('--hidden_dim', type=int, default=768)
    
    parser.add_argument('--cl_lang_layer', type=int, default=-1)
    parser.add_argument("--train_alg", type=str, default='sample', choices=['dagger', 'imitation', 'sample'])
...
def postprocess_args(args):
    ...
    if args.dataset == 'cvdn':
        ...
        args.anno_dir = os.path.join(ROOTDIR, 'CVDN', 'annotations', 'ndh', 'dual_level')
